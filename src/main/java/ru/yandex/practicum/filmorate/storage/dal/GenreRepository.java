...
public class GenreRepository {
    ...
    public Optional<Genre> findById(Long id) {
        try {
            return Optional.ofNullable(
                    jdbc.queryForObject(FIND_BY_ID, genreRowMapper, id)
            );
    ...
    public Set<Genre> findByFilmId(Long filmId) {
        return new LinkedHashSet<>(jdbc.query(FIND_BY_FILM_ID, genreRowMapper, filmId));
    }
    ...
    public Map<Long, Set<Genre>> findGenresForFilms(Set<Long> filmIds) {
        ...
        return namedParameterJdbc.query(FIND_GENRES_FOR_FILMS, params, rs -> {
    ...
    public void updateGenres(Long filmId, Set<Long> newGenreIds) {
        jdbc.update(DELETE_GENRES, filmId);
